...
IS
    ...
    msg_from VARCHAR2(50) := '192.168.1.36'; -- ip address database server 
    ...
    base64password VARCHAR2(30) := UTL_RAW.cast_to_varchar2(UTL_ENCODE.base64_encode(UTL_RAW.cast_to_raw('my_post_password')));
BEGIN
